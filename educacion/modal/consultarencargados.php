...
<div class="form-group">
 ...
 <input type="text" class="form-control inp" id="nombrep" name="nombrep" placeholder="Nombre" autocomplete="off" required tabindex="1" disabled>
                  </div>
                </div>
            ...
            <div class="form-group">
               ...
               <div class="controls col-md-8 ">
 <input type="text" class="form-control inp" id="apellidop" name="apellidop" placeholder="Apellido" autocomplete="off" required tabindex="2"disabled>
                  </div>
                </div>
 ...
 <input type="text" class="form-control inp" id="identidadp" name="identidadp" placeholder="Identidad" autocomplete="off" required tabindex="3" disabled>
        ...
        <input type="text" class="form-control inp" id="telefonop" name="telefonop" placeholder="Telefono"  autocomplete="off" required tabindex="4" disabled>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
        <select name="tipop" id="tipop" class="form-control input-sm" required tabindex="5"disabled >
