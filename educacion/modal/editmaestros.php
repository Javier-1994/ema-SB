...
<input type="hidden" class="form-control inp" id="idmaestro" name="idmaestro" placeholder="idmaestro">
 ...
 <input type="text" class="form-control inp" id="identidadp" name="identidadp" placeholder="Identidad" autocomplete="off" required tabindex="3" disabled>
        ...
        <input type="text" class="form-control inp" id="telefonop" name="telefonop" placeholder="Telefono"  autocomplete="off" required tabindex="4">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
        <select name="estadoe" id="estadoe" class="form-control input-sm" required tabindex="5">>
      ...
      <button type="submit" class="btn btn-primary" id="Updatedmaestros">Actualizar datos</button>
      </div>
      </form>
    </div>
    </div>
