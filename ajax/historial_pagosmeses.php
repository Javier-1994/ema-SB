...
<!--otro-->
        ...
        <div class="x_panel" >
                        ...
                        <h2>Buscar mensualidades pagadas por alumno</h2>
    ...
    $(document).on('ready',function(){
      ...
      $('#btn-ingresar').click(function(){
        ...
        var url = "ajax/busca_mensualidad.php";                                      

        if (alumno.val()=='') {
      alert('Seleccione un alumno para revisar sus mensualidades canceladas');
      return false;
    } else {
...
<script>
  ...
  <body>
    ...
    <div class="form-group">
                ...
                <div class="col-sm-4">
               <input type="text" class="form-control" name="idalumno"  list="idalumno" id="alumno" placeholder="Ingrese el nombre o identidad"   required>
       ...
       <select id="idalumno"  name="idalumno" autocomplete="off">
           ...
           or die(mysqli_error());
            ...
            ?>
              ...
              <div class="form-group">
                <label for="user_name" class="col-sm-1 control-label">Año</label>
                <div class="col-sm-4">
              <select class="form-control input-sm"  id="anio" name="anio">
       <option value="" selected>-Seleccione Año-</option>
                  <?php
                    $sql_vendedor=mysqli_query($con,"SELECT DISTINCT fecha_an from pagos order by fecha_an");
                    while ($rw=mysqli_fetch_array($sql_vendedor)){
                      $fecha_an=$rw["fecha_an"];
                      //$nombre_linea=$rw["nombre_linea"];
                      ?>
                      <option value="<?php echo $fecha_an?>" ><?php echo $fecha_an?></option>
                      <?php
                    }
                  ?>
                  </select>          
...
function impresion(){
 ...
 VentanaCentrada('pdf/reporteria/pagos_mensualidades.php?f1='+alumno+'&f2='+anio,'Pagos','','1024','768','true');
 }
    </script>
