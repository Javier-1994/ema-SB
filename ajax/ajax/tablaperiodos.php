  ...
  .boton_personalizado:hover{
    ...
    background-color: #ffffff;
			...
			<th width="20%">Acciones</th>
				...
				<tbody>
				<?php
$Table="SELECT * FROM periodo WHERE estado_p='1'";
...
<input type="button" class="btn btn-default" data-toggle="modal" data-target="#dataf" data-codigo_final="<?php echo $row['id_periodo']?>" data-codigo_pe="<?php echo $row['codigo_p']?>"  value="Cerra Periodo">
