  ...
  <div class="modal fade" id="dataConsult" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   ...
   <div class="form-group">
                ...
                <div class="col-sm-8">
        <input type="text" class="form-control inp" id="idalumnop" name="idalumnop" placeholder="Nombre Alumno"  autocomplete="off" required tabindex="1" disabled="">
                </div>
              </div>
   ...
   <div class="form-group">
                ...
                <div class="col-sm-8">
        <input type="text" class="form-control inp" id="fechap" name="fechap" placeholder="Fecha"  autocomplete="off" required tabindex="2" disabled="">
                </div>
              </div>
             ...
             <div class="form-group">
                ...
                <div class="col-sm-8">
        <textarea class="form-control inp" id="descripcionp" name="descripcionp" placeholder="Descripción"  autocomplete="off" required tabindex="3" disabled=""></textarea>   
