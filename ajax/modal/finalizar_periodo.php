<?php
  ...
  ?>
  <!-- Modal -->
  <div class="modal fade" id="dataf" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<div class="form-group">
      ...
      <button type="button" class="btn btn-default" id="limp" data-dismiss="modal">Cancelar</button>
       <button type="submit" class="btn btn-primary" id="finalizar_periodo">Aceptar</button>
